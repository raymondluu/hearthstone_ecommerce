...
class Order extends CI_Model {
    ...
    public function add_order($post, $cust_cart)
    {
      ...
      foreach ($cust_cart as $cust_cart) {
        $query3 = "INSERT INTO orders (card_id, quantity, total_price, created_at, updated_at)
        VALUES(?, ?, ?, NOW(), NOW())";
        $values3 = array($cust_cart['Card_ID'], $cust_cart['card_quantity'], $cust_cart['price']);
