...
<body>
    ...
    <div class="col-lg-9 col-lg-offset-1">
        ...
        <table class="table table-striped table-bordered table-condensed">
            <thead>
                <th class="col-lg-3 tbl-head-bg">Item</th>
                <th class="col-lg-2 tbl-head-bg">Price</th>
                <th class="col-lg-2 tbl-head-bg">Quantity</th>
                <th class="col-lg-2 tbl-head-bg">Total</th>
            </thead>
            <tbody>
                <tr>
                    <?php $total_price = 0.0;
